/****************************************************************************
 *                                                                           *
 *   Geonect 1.0 - A 3D modeling interface                                   *
 *                                                                           *
 *   Author: Michelle Bourgeois, Charles Dietrich, and Benjamin Link         *
 *                                                                           *
 ****************************************************************************/
// Headers for OpenNI
#include <XnOpenNI.h>
...
typedef enum {
  ...
  DESELECTED // the shape is deselected, select an object or open tool menu
} UserMode;
...
// load a 64x64 RGB .RAW file as a texture.  Images must be a power of 2.
...
// Apply the tool's texture to a square region.  
...
// Callback for no hands detected
...
// Brings up the Shape Selection menu
...
// Brings up the Tool Selection menu
